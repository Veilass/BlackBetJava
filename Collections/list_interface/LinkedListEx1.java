...
public class LinkedListEx1 {
    public static void main(String[] args) {
        Student2 st1 = new Student2("Vasya", 2);
        Student2 st2 = new Student2("Masha", 4);
        Student2 st3 = new Student2("Kolya", 3);
        Student2 st4 = new Student2("Oleg", 1);
        ...
        System.out.println("LinkedLis = " + student2LinkedList);
        System.out.println(student2LinkedList.get(3));

        Student2 st6 = new Student2("Zaur", 3);
        Student2 st7 = new Student2("Ivan", 2);
